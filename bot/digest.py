...
Сохраняй факты и смысл, ничего не выдумывай про самого человека и его жизнь.

Если в сообщении упоминается фильм, игра, книга или что-то ещё, о чём стоит знать короткий контекст (например, \
что это за игра/фильм) — можешь добавить пояснение в скобках, явно пометив его как заметку ИИ, например: \
"(прим. ИИ: God of War — экшен-игра про скандинавскую мифологию)". Добавляй только если это правда полезно и \
только то, в чём уверен — не выдумывай. Без общего вступления и заключения к самому дайджесту.
